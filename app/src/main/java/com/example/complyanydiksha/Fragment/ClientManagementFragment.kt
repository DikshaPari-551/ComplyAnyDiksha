 ...
 * Use the [ClientManagementFragment.newInstance] factory method to
...
class ClientManagementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ClientManagementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ClientManagementFragment().apply {
