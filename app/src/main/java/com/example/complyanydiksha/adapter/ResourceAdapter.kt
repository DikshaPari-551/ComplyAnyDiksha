package com.example.complyanydiksha.adapter
...
class ResourceAdapter (val context : Context, val itemList: ArrayList<ResourceModelClass>) :RecyclerView.Adapter<ResourceAdapter.myViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): myViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.recycler_resource_layout, parent, false)
    ...
    class myViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        val LastUpdate = view.findViewById<TextView>(R.id.LastUpRes)
    }
}